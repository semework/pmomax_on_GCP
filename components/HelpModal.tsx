...
const SECTION_HELP: Record<string, HelpEntry> = {
  ...
  assistant: {
    ...
    bullets: [
      ...
      'Use the **Risk** and **Compliance** buttons in the left panel to run focused reviews. Their findings appear in the AI Assistant as replies and can be applied to the PID or merged into the Risks / Compliance sections after human review.',
    ],
  },
  export: {
    title: 'Export',
  ...
  risks: {
    ...
    bullets: [
      'Use Risk review to scan the PID, surface candidate risks, and prioritize by likelihood and impact.',
  ...
  issues: {
    ...
    bullets: [
      ...
      'This supports the project decision trail during delivery.',
    ],
  },
  communication: {
  ...
  compliance: {
    ...
    bullets: [
      'Run Compliance review to generate checklist items for privacy, security, and legal reviews.',
...
const MAIN_HELP_MARKDOWN = `PMOMax helps turn project inputs into a consistent, reviewable Project Initiation Document (PID).
...
5. Use **Export** to download available formats such as **Word**, **PDF**, or **JSON** (with General Notes included when supported).
