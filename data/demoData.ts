...
export const demoData: PMOMaxPID = {
  // 1) Title / Cover
  titleBlock: {
  ...
  problemStatement:
    'Current customer service processes are fragmented across multiple tools and vendors, creating handoff gaps between chat, SMS, and voice. Agents lack a unified view and consistent workflows, and customers face long wait times and repeated contacts for the same issue.',

  // 4) Business Case & Expected Value
  businessCaseExpectedValue:
    'Consolidating channels into a single agent workspace is expected to reduce response times and rework, improve customer satisfaction, and create measurable operational savings. Value is realized through fewer repeats, better deflection, and smoother agent workflows—validated via consistent instrumentation before dashboards and reporting.',
  ...
  timelineOverview:
    'Kickoff 10/29/2025. Foundation work in Nov–Dec, core build Dec–Jan, integration late Jan–early Feb, pilot readiness early Feb, pilot launch 02/17/2026 for five test markets.',
