...
export function validatePMOMaxPID(data) {
    var _a, _b, _c;
    // 1. Size guards
    ...
    if (!((_a = data.titleBlock) === null || _a === void 0 ? void 0 : _a.projectTitle) || !((_b = data.titleBlock) === null || _b === void 0 ? void 0 : _b.subtitle) || !((_c = data.titleBlock) === null || _c === void 0 ? void 0 : _c.generatedOn)) {
        return {
