...
export type AuditTraceLevel = 'meta' | 'summary' | 'full';
...
export interface PMOMaxPID {
  ...
  // Optional deliverable list used by parser/create flows when the scope section includes concrete outputs.
  deliverablesOutputs?: Array<{
    name: string;
    description?: string;
    owner?: string;
    dueDate?: string;
